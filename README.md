...
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | -------------------------------------------------------- |
| ファイル作成                                                                                     | `aaa`                                                                                                                                      |                                                                                            |                                                          |
| フォルダ作成                                                                                     | `pd.mkdir(mode=0o777, parents=False, exist_ok=False)`                                                                                      | `mode` がある場合、プロセスの umask 値と組み合わせてファイルのモードとアクセスフラグを決定 |                                                          |
...
| ファイルの内容をバイナリデータとして取得                                                         | `pf.read_bytes()`                                                                                                                          |                                                                                            |                                                          |
| ファイルの内容をテキストデータ（文字列型）として取得                                             | `pf.read_text()`                                                                                                                           |                                                                                            |                                                          |
|                                                                                                  |                                                                                                                                            |                                                                                            |                                                          |
|                                                                                                  |                                                                                                                                            |                                                                                            |                                                          |
