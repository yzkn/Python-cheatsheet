...
soup = BeautifulSoup(r.content, 'lxml', from_encoding='utf-8') # BeautifulSoup(r.text, from_encoding='Shift_JIS')
...
print('soup.find(id=\'foot-link\').string:',     soup.find(id='foot-link').string)     # None（タグに１つしか子ノードがなく、その子ノードが文字列であればtag.stringとして参照できる）
